/*
Скрипт развертывания для coursesDB
...
GO
:setvar DatabaseName "coursesDB"
:setvar DefaultFilePrefix "coursesDB"
:setvar DefaultDataPath "C:\Users\Повелитель\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB"
:setvar DefaultLogPath "C:\Users\Повелитель\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB"
...
GO
PRINT N'Выполняется создание [dbo].[FK_Comments_Posts]...';


GO
ALTER TABLE [dbo].[Comments]
    ADD CONSTRAINT [FK_Comments_Posts] FOREIGN KEY ([PostId]) REFERENCES [dbo].[Posts] ([Id]);


GO
PRINT N'Выполняется создание [dbo].[AllComments]...';
...
GO
PRINT N'Выполняется создание [dbo].[AllPosts]...';


GO
CREATE VIEW [dbo].[AllPosts]
	AS SELECT Author, Title, Content, DateCreate FROM Posts;
GO
PRINT N'Выполняется создание [dbo].[AddComment]...';
...
RETURN 0
GO
PRINT N'Выполняется создание [dbo].[AddPost]...';
...
RETURN 0
GO
PRINT N'Выполняется создание [dbo].[DeleteAllPostComments]...';
